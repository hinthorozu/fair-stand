...
test('listCatalogItems 55 görünür Item’ı Item kaydından üretir; hardcoded key listesi yoktur', () => {
  ...
  assert.equal(new Set(projected.map((item) => item.itemKey)).size, 55);
