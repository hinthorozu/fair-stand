...
if (!source.includes('const weaveA = Math.sin((x * 0.34) + (y * 0.11)) * 11;')) {
  throw new Error('Carpet generator could not be tuned');
}
if (!source.includes('material.bumpScale = 0.032;')) {
  throw new Error('Carpet material could not be tuned');
}
