...
- persist edilen ürün kimliği yalnız `itemKey` mı; Category `id` veya eski `catalogKey` ürün kimliği olarak okunuyor veya yazılıyor mu?
...
1. Fresh `main` üzerinden branch oluştur.
