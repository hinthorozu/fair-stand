...
export function getModulePlacementSnapCm(moduleType) {
  return moduleType === 'sofa-set-beige' || moduleType === 'table-chair-set-eames' || moduleType === 'bar-stool'
    ? 10
...
function createFreePlacement({
  ...
  if (strictDepth) {
    ...
    const useWallInnerFaces = moduleType === 'sofa-set-beige' || moduleType === 'table-chair-set-eames' || moduleType === 'bar-stool';
