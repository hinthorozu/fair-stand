...
export function planContinuousModuleInsert({
  ...
  const directValidation = validatePlacementAgainstModules({
    ...
    moduleType: insertedModule.type,
    itemKey: insertedModule.itemKey,
    heightCm: insertedModule.heightCm,
    shape: insertedModule.shape,
    depthCm: insertedModule.depthCm,
    modules,
    standType,
    standXCm,
    standYCm,
...
export function planContinuousModuleMove({
  ...
  const directValidation = validatePlacementAgainstModules({
    ...
    moduleType: movingModule.type,
    itemKey: movingModule.itemKey,
    heightCm: movingModule.heightCm,
    shape: movingModule.shape,
    depthCm: movingModule.depthCm,
