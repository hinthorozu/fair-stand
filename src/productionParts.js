export const PRODUCTION_PARTS = Object.freeze({
  ...
  panel_98: Object.freeze({ itemKey: 'panel_98', name: 'Panel 98 × 47 cm', type: 'panel', unit: 'adet', dimensions: Object.freeze({ widthCm: 98, heightCm: 47, thicknessCm: 0.8 }), panelRole: 'straight', nominalModuleWidthCm: 100 }),
  panel_147_5: Object.freeze({ itemKey: 'panel_147_5', name: 'Panel 147,5 × 47 cm', type: 'panel', unit: 'adet', dimensions: Object.freeze({ widthCm: 147.5, heightCm: 47, thicknessCm: 0.8 }), panelRole: 'straight', nominalModuleWidthCm: 150 }),
  ...
  panel_corner_42_5: Object.freeze({ itemKey: 'panel_corner_42_5', name: 'İç Köşe Paneli 42,5 × 47 cm', type: 'panel', unit: 'adet', dimensions: Object.freeze({ widthCm: 42.5, heightCm: 47, thicknessCm: 0.8 }), panelRole: 'inner-corner', nominalModuleWidthCm: 50 }),
  panel_corner_92: Object.freeze({ itemKey: 'panel_corner_92', name: 'İç Köşe Paneli 92 × 47 cm', type: 'panel', unit: 'adet', dimensions: Object.freeze({ widthCm: 92, heightCm: 47, thicknessCm: 0.8 }), panelRole: 'inner-corner', nominalModuleWidthCm: 100 }),
  ...
  counter_top_110_60: Object.freeze({ itemKey: 'counter_top_110_60', name: 'Banko Üstü 110 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 110, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 100 }),
  counter_top_52_60: Object.freeze({ itemKey: 'counter_top_52_60', name: 'Banko Üstü 52 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 52, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 100 }),
  counter_top_160_60: Object.freeze({ itemKey: 'counter_top_160_60', name: 'Banko Üstü 160 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 160, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 150 }),
  counter_top_102_60: Object.freeze({ itemKey: 'counter_top_102_60', name: 'Banko Üstü 102 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 102, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 150 }),
  counter_top_210_60: Object.freeze({ itemKey: 'counter_top_210_60', name: 'Banko Üstü 210 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 210, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 200 }),
  counter_top_150_60: Object.freeze({ itemKey: 'counter_top_150_60', name: 'Banko Üstü 150 × 60 cm', type: 'counter-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 150, depthCm: 60, thicknessCm: 1.8 }), defaultColor: 0xf8fafc, nominalModuleWidthCm: 200 }),

  base_top_107_50: Object.freeze({ itemKey: 'base_top_107_50', name: 'Baza Üstü 107 × 50 cm', type: 'base-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 107, depthCm: 50, thicknessCm: 1.8 }), nominalModuleWidthCm: 100 }),
  base_top_157_50: Object.freeze({ itemKey: 'base_top_157_50', name: 'Baza Üstü 157 × 50 cm', type: 'base-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 157, depthCm: 50, thicknessCm: 1.8 }), nominalModuleWidthCm: 150 }),
  base_top_206_50: Object.freeze({ itemKey: 'base_top_206_50', name: 'Baza Üstü 206 × 50 cm', type: 'base-top', unit: 'adet', dimensions: Object.freeze({ widthCm: 206, depthCm: 50, thicknessCm: 1.8 }), nominalModuleWidthCm: 200 }),
});
