...
Kod/UI: F-015, F-018, F-021, F-022 (foam/kapı/ZIP e2e eksik), F-024, F-025, F-026, F-029, F-030, F-031, F-032, F-035, F-036/037, F-038, F-039, F-042, F-045, F-046. F-017 kapandı (`surfaceState` kopya).
...
**Uygulandı:** F-017 (renderer kopya; kalıcı yazı `designState` bağında). Kalan: F-018, F-021/032/035, F-029 + `contentCatalogKeys`, F-022, F-045.
