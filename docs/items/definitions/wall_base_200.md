...
`src/items.js > COMPOSITE_ITEMS.wall_base_200` canonical itemKey/name/type/dimensions sahibidir. Bileşik Item; `itemKey = wall_base_200`. Type ailesi `base-wall`; ölçü `200 × 50 × 350 cm` (katalog/envanter). Parent üzerinde unit uydurulmadı.
