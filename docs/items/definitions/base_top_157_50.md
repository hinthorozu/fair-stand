...
Bağımsız leaf proje örneği oluşturucu, mutable state, project `id` ve kalıcılık entity'si **UYGULANMIYOR**. Parent catalog Item'ı `BASE_150`'dır. Leaf production identity recipe + `getItem()` üzerinden çözülür.
