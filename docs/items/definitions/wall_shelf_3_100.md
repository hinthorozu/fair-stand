...
`src/items.js > COMPOSITE_ITEMS.wall_shelf_3_100` canonical itemKey/name/type/shelfCount/dimensions sahibidir. Bileşik Item; `itemKey = wall_shelf_3_100`. Type ailesi `shelf`; genişlik 100 cm; `shelfCount = 3`. Parent üzerinde unit uydurulmadı. Production `shelf_100` board Item'ından ayrıdır.
