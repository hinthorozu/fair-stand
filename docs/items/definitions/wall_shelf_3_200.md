...
`src/items.js > COMPOSITE_ITEMS.wall_shelf_3_200` canonical itemKey/name/type/shelfCount/dimensions sahibidir. Bileşik Item; `itemKey = wall_shelf_3_200`. Type ailesi `shelf`; genişlik 200 cm; `shelfCount = 3`. Parent üzerinde unit uydurulmadı. Production `shelf_200` board Item'ından ayrıdır.
