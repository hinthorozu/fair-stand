...
`src/items.js > COMPOSITE_ITEMS.desk_banko_150` canonical itemKey/name/type/dimensions sahibidir. Bileşik Item; `itemKey = desk_banko_150`. Type ailesi `counter`; straight genişlik 150 cm. Doğrulanmış ölçüler: `widthCm=150`, `depthCm=50`, `heightCm=100`. Parent üzerinde unit uydurulmadı.
