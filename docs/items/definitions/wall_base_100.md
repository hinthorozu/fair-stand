...
`src/items.js > COMPOSITE_ITEMS.wall_base_100` canonical itemKey/name/type/dimensions sahibidir. Bileşik Item; `catalogKey = itemKey = wall_base_100`. Type ailesi `base-wall`; ölçü `100 × 50 × 350 cm` (katalog/envanter). Parent üzerinde unit uydurulmadı.
