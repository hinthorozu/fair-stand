# EXTRA_LONG_PLANTER_150 — Canonical Item
...
`src/items.js > INDOOR_PLANT_ITEMS.EXTRA_LONG_PLANTER_150` canonical itemKey/name/type/dimensions/modelFile sahibidir. Tekil Item; `itemKey = EXTRA_LONG_PLANTER_150`. Type ailesi `indoor-plant-1`; ölçü 150×30×30 cm; `modelFile = saksi_bitkili_150x30x30.glb`; `modelRotationYDeg=90`; `preserveModelScale=true`. Parent unit / BOM uydurulmadı.
