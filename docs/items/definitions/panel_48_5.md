...
Intrinsic ürün gerçeğinin source-of-truth'u `PRODUCTION_PARTS.panel_48_5` kaydıdır. State, placement, move, rotation, snap, collision, selection, context-menu, delete/duplicate ve persistence parent module/type tarafından uygulanır. Renderer specialized override yapabilir ancak `material` dahil product source-of-truth'u değiştirmez.
