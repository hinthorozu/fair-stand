...
Intrinsic ürün gerçeğinin tek kaynağı `PRODUCTION_PARTS.panel_48_5` kaydıdır. State, yerleşim, move, rotation, snap, collision, selection, context-menu, delete/duplicate ve kalıcılık parent module/type tarafından uygulanır. Renderer specialized ezme yapabilir ancak `material` dahil product tek kaynağı değiştirmez.
