...
`src/items.js > COMPOSITE_ITEMS.BASE_150` canonical itemKey/name/type/dimensions sahibidir. Bileşik Item; `itemKey = BASE_150`. Tek type ailesi `base`; genişlik varyantı 150 cm. Doğrulanmış ölçüler: `widthCm=150`, `depthCm=50`, `heightCm=50`. Parent üzerinde unit uydurulmadı.
