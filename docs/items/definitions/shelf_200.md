...
Intrinsic ürün gerçeğinin tek kaynağı `LEAF_ITEMS.shelf_200` kaydıdır. Leaf raf ayrı project entity değildir; yerleşim, move, rotation, snap/collision/connection, selection/drag, context menu, delete/duplicate/keyboard, kalıcılık ve reflow parent `shelf` module/type tarafından uygulanır.
