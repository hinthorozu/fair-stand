...
## Bileşim / BOM
`composition.mode=recipe`, `moduleType=separator`; recipe lookup `item.dimensions.widthCm=50`. Miktar tek kaynak: aynı `separator:50` (düz 50 ile paylaşır). Recipe miktarları değişmez. Raw BOM UI dokunulmadı.
