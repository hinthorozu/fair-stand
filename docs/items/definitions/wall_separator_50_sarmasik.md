...
`src/items.js > COMPOSITE_ITEMS.wall_separator_50_sarmasik` canonical itemKey/name/type/modelFile/dimensions sahibidir. Bileşik Item; `itemKey = wall_separator_50_sarmasik`. Type ailesi `separator`; genişlik 50 cm; `modelFile = wall_separator_50_sarmasik.glb`. Parent üzerinde unit uydurulmadı.
