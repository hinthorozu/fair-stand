...
`src/items.js > COMPOSITE_ITEMS.wall_base_150` canonical itemKey/name/type/dimensions sahibidir. Bileşik Item; `itemKey = wall_base_150`. Type ailesi `base-wall`; ölçü `150 × 50 × 350 cm` (katalog/envanter). Parent üzerinde unit uydurulmadı.
