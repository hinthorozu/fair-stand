...
## Bileşim / BOM
`composition.mode=recipe`, `moduleType=shelf`, `nominalWidthCm=150`, `options.shelfCount=3`. Miktar tek kaynak: `src/moduleRecipes.js` `shelf:150:3`. Alt satırları Item kartında kopyalanmaz; mevcut recipe miktarları değişmez. Raw BOM UI dokunulmadı.
