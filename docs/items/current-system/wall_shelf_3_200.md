> Migration öncesi envanterdir; aktif kanonik tanım `../definitions/wall_shelf_3_200.md` içindedir.

# wall_shelf_3_200 — Tarihî envanter profili
...
| Alan | Kod değeri |
|---|---|
| Katalog anahtarı | `wall_shelf_3_200` |
| Etiket | `Raf 200 · 3 Raf` |
| Type | `shelf` |
| Genişlik | `200 cm` |
| Shelf count | `3` |
