> Migration öncesi envanterdir; aktif canonical tanım `../definitions/MINI_FRIDGE_AVANTI.md` içindedir. Eski kayıt uyumluluğu kullanıcı kararıyla kapsam dışıdır.
...
| Alan | Kod değeri |
|---|---|
| Catalog key | `DEPOT_MINI_FRIDGE_AVANTI` |
