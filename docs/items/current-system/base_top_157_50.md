...
## 4. Factory / creation
Bağımsız leaf factory **UYGULANMIYOR**. Item `getProductionItem('base_top_157_50')` ile resolve edilir; parent instance ilgili base/base-wall factory/state yolundan oluşur.
