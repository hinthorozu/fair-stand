...
Kanonik kaynak `src/items.js` → `LEAF_ITEMS.base_top_157_50`.
...
## 4. Factory / creation
Bağımsız leaf factory **UYGULANMIYOR**. Item `getItem('base_top_157_50')` ile resolve edilir; parent instance ilgili base/base-wall factory/state yolundan oluşur.
