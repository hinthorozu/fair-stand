...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=panel_corner_192`, `type=panel`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `192 × 47 × 0.8 cm`, `material=sunta`, `panelRole=inner-corner`, nominal `200` |
