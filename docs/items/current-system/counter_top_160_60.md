...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=counter_top_160_60`, `type=counter-top`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `160 × 60 × 1.8 cm`, `material=sunta`, `defaultColor=0xf8fafc`, nominal `150` |
| 3 | Default state | PARENT-OWNED | Counter face state parent counter instance içindedir. |
| 4 | Factory / creation | PARENT-OWNED | Parent counter factory/state oluşturma zinciri. |
...
| 13 | Persistence | PARENT-OWNED | Counter module state persist edilir; top leaf ayrı entity değildir. |
...
Canonical üretim malzemesi `material: 'sunta'`dır.
