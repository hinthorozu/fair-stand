> Migration öncesi envanterdir; aktif kanonik tanım `../definitions/desk_banko_150.md` içindedir.

# desk_banko_150 — Tarihî envanter profili
...
| Alan | Kod değeri |
|---|---|
| Katalog anahtarı | `desk_banko_150` |
| Etiket | `Banko 150` |
| Type | `counter` |
| Shape | `straight` |
| Genişlik | `150 cm` |
