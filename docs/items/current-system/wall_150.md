...
`panel_corner_142_5` production registry kaydı: `İç Köşe Paneli 142,5 × 47 cm` (widthCm=142.5, heightCm=47, depthCm=0.8). Bu part normal `recipe.items` satırlarında yer almaz.
