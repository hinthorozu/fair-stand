...
# separator_panel_98 — Tarihî envanter
...
The leaf production Item has no independent project state. `createSeparatorModuleState(100)` creates the parent separator surface and now derives its initial `#c79b63` color from this kanonik Item default.
