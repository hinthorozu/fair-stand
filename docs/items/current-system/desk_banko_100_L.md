> Migration öncesi envanterdir; aktif kanonik tanım `../definitions/desk_banko_100_L.md` içindedir.

# desk_banko_100_L — Tarihî envanter profili
...
| Alan | Kod değeri |
|---|---|
| Katalog anahtarı | `desk_banko_100_L` |
| Etiket | `Köşe Banko 100×100` |
| Type | `counter` |
| Shape | `L` |
| Genişlik | `100 cm` |
| Derinlik | `100 cm` |
