...
Kanonik Item properties: `widthCm=8`, `depthCm=8`, `heightCm=49.5`, `material='alüminyum'`, `defaultColor=0xd0d3d4`. Renderer may explicitly override visual representation without changing the Item default.
