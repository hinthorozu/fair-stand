...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=panel_corner_42_5`, `type=panel`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `42.5 × 47 × 0.8 cm`, `material=sunta`, `panelRole=inner-corner`, nominal `50` |
| 3 | Default state | UYGULANMIYOR | Ayrı leaf project state yok. |
| 4 | Factory / creation | UYGULANMIYOR | Ayrı scene/project factory yok. |
...
| 13 | Persistence | PARENT-OWNED | Relationship/module state üzerinden; leaf ayrı entity değildir. |
