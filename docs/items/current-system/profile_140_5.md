# profile_140_5 — Current System Inventory

Baseline: `Version2`. Bu envanter `ITEM_CONTRACT_CHECKLIST.md` zorunlu kapsamına göre fresh runtime doğrulamasıdır.

## 1. Identity / type — VAR
`itemKey=profile_140_5`, `name=Profil 140,5 cm`, `type=profile`, `unit=adet`; owner `src/productionParts.js`. Legacy `partId`: YOK.
