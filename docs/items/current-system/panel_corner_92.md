...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=panel_corner_92`, `type=panel`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `92 × 47 × 0.8 cm`, `material=sunta`, `panelRole=inner-corner`, nominal `100` |
