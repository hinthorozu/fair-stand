...
Product decision confirmed: upright material is aluminum and kanonik default color is `#D0D3D4`. No renderer/state/placement/persistence migration is required for this property change.
