...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=counter_top_52_60`, `type=counter-top`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `52 × 60 × 1.8 cm`, `material=sunta`, `defaultColor=0xf8fafc`, nominal `100` |
