> Migration öncesi envanterdir; aktif kanonik tanım `../definitions/wall_shelf_2_100.md` içindedir.

# wall_shelf_2_100 — Tarihî envanter profili
...
| Alan | Kod değeri |
|---|---|
| Katalog anahtarı | `wall_shelf_2_100` |
| Etiket | `Raf 100 · 2 Raf` |
| Type | `shelf` |
| Genişlik | `100 cm` |
| Shelf count | `2` |
