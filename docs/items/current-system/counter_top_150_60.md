...
|---:|---|---|---|
| 1 | Identity / type | VAR | `itemKey=counter_top_150_60`, `type=counter-top`, `unit=adet` |
| 2 | Intrinsic properties | VAR | `150 × 60 × 1.8 cm`, `material=sunta`, `defaultColor=0xf8fafc`, nominal `200` |
