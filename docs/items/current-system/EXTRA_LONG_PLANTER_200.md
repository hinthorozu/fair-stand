> Migration öncesi envanterdir; aktif canonical tanım `../definitions/EXTRA_LONG_PLANTER_200.md` içindedir.
...
| Alan | Kod değeri |
|---|---|
| Catalog key | `EXTRA_LONG_PLANTER_200` |
| Label | `Uzun Saksı 200` |
| Type | `indoor-plant-1` |
| Width | `200 cm` |
| Depth | `30 cm` |
| Height | `30 cm` |
| Model file | `saksi_bitkili_200x30x30.glb` |
