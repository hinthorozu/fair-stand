...
**Özellik ID:** `behavior.collisionHeightRange`
**İnsan tarafından anlaşılır adı:** Hesaplanan çarpışma yükseklik aralığı
**Kategori:** davranis
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `"{""minCm"":0,""maxCm"":350}"` · `"{""minCm"":0,""maxCm"":47}"` · `"{""minCm"":0,""maxCm"":200}"` · `"{""minCm"":0,""maxCm"":180}"` · `"{""minCm"":0,""maxCm"":25}"` · `"{""minCm"":0,""maxCm"":66}"` · `"{""minCm"":0,""maxCm"":60}"` · `"{""minCm"":0,""maxCm"":78}"` · `"{""minCm"":0,""maxCm"":38}"` · `"{""minCm"":0,""maxCm"":82}"` · `"{""minCm"":0,""maxCm"":74}"` · `"{""minCm"":0,""maxCm"":121}"` (+7)
...
- `src/moduleBehavior.js` `getModuleCollisionHeightRangeCm` :269 [read]

## Okuyan yerler

- `src/moduleBehavior.js` `getModuleCollisionHeightRangeCm` :269 [read]
- `src/modulePlacement.js` (dosya düzeyi) :7 [read]
- `test/moduleBehaviorPolicy.test.js` (dosya düzeyi) :10 [test]
- `test/moduleBehaviorPolicy.test.js` `for` :98 [test]
- `test/wallFlatPanelItemsContract.test.js` (dosya düzeyi) :11 [test]

## Yazan / değiştiren yerler

- `src/modulePlacement.js` `collisionHeightsOverlap` :528 [write]
