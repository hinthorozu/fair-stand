...
**Özellik ID:** `contract.runtime.mode`
**İnsan tarafından anlaşılır adı:** Sözleşme runtime sınıfı
**Kategori:** sozlesme
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `static`
...
- `src/moduleContracts.js` `MODULE_CONTRACT_PROFILES` :32 [write-or-literal]
