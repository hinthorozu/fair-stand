...
**Özellik ID:** `contract.composition.mode`
**İnsan tarafından anlaşılır adı:** Sözleşme composition sınıfı (profil)
**Kategori:** sozlesme
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `standalone`
