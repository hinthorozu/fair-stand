...
**Özellik ID:** `catalog.visualRotationYDeg`
**İnsan tarafından anlaşılır adı:** Katalog descriptor: visualRotationYDeg
**Kategori:** katalog
**Veri tipi:** number (derece)
**Birim:** derece
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `-90`
