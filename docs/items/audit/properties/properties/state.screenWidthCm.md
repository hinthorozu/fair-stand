...
**Özellik ID:** `state.screenWidthCm`
**İnsan tarafından anlaşılır adı:** Runtime module state: screenWidthCm
...
- `test/wallMediaItemsContract.test.js` (dosya düzeyi) :23 [test]
