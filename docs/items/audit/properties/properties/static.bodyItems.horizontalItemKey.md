...
**Özellik ID:** `static.bodyItems.horizontalItemKey`
**İnsan tarafından anlaşılır adı:** Vitrin bodyItems.horizontalItemKey
**Kategori:** kanonik-kayit
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `showcase_horizontal_87_4_30`
...
- `src/items.js` (dosya düzeyi) :938 [write-or-literal]
