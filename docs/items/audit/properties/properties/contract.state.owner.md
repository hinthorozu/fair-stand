...
**Özellik ID:** `contract.state.owner`
**İnsan tarafından anlaşılır adı:** State sahibi dosya (sözleşme)
**Kategori:** sozlesme
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `src/designState.js`
...
- `src/moduleContracts.js` `MODULE_CONTRACT_PROFILES` :29 [write-or-literal]
