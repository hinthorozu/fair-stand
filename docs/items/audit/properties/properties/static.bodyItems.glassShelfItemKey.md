...
**Özellik ID:** `static.bodyItems.glassShelfItemKey`
**İnsan tarafından anlaşılır adı:** Vitrin bodyItems.glassShelfItemKey
**Kategori:** kanonik-kayit
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `glass_shelf`
...
- `src/items.js` (dosya düzeyi) :939 [write-or-literal]
