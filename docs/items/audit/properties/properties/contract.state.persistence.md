...
**Özellik ID:** `contract.state.persistence`
**İnsan tarafından anlaşılır adı:** Sözleşme persistence kipi
**Kategori:** sozlesme
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `project-state`
