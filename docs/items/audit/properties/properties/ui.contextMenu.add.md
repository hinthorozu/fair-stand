...
**Özellik ID:** `ui.contextMenu.add`
**İnsan tarafından anlaşılır adı:** Context menu yanına ekle
**Kategori:** ui-audit
**Veri tipi:** boolean
**Birim:** yok / birimsiz
...
- `src/moduleContextMenu.js` `if` :496 [read]

## Yazan / değiştiren yerler

- `src/moduleContextMenu.js` `createModuleContextMenu` :56 [write]
