...
**Özellik ID:** `static.dimensions.screenWidthCm`
**İnsan tarafından anlaşılır adı:** Kanonik ölçü: screenWidthCm
**Kategori:** kanonik-kayit
**Veri tipi:** number
**Birim:** cm
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `93` · `121.8` · `143.9`

## Ne işe yarar

Kanonik screenWidthCm. Catalog/factory/collision/BOM ilgili katmanlar bu ölçüyü veya ondan türetilmiş kopyayı okur.
