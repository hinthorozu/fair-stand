...
**Özellik ID:** `ui.editable.shelfLight`
**İnsan tarafından anlaşılır adı:** Raf altı ışık (audit)
**Kategori:** ui-audit
**Veri tipi:** string
**Birim:** yok / birimsiz
...
- `src/moduleContextMenu.js` `if` :489 [read]
...
- `src/moduleContextMenu.js` `createModuleContextMenu` :55 [write]
