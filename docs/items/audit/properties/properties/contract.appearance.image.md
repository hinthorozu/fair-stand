...
**Özellik ID:** `contract.appearance.image`
**İnsan tarafından anlaşılır adı:** Sözleşme görsel yetkisi
**Kategori:** sozlesme
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `editable` · `none` · `renderer-managed` · `required`
