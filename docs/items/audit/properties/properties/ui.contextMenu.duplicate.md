...
**Özellik ID:** `ui.contextMenu.duplicate`
**İnsan tarafından anlaşılır adı:** Context menu çoğalt
**Kategori:** ui-audit
**Veri tipi:** boolean
**Birim:** yok / birimsiz
...
- `src/moduleContextMenu.js` `if` :457 [read]

## Yazan / değiştiren yerler

- `src/moduleContextMenu.js` `createModuleContextMenu` :47 [write]
...
- src dosyaları: `src/moduleContextMenu.js`
