...
**Özellik ID:** `static.dimensions.screenHeightCm`
**İnsan tarafından anlaşılır adı:** Kanonik ölçü: screenHeightCm
**Kategori:** kanonik-kayit
**Veri tipi:** number
**Birim:** cm
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `52.3` · `68.5` · `80.9`

## Ne işe yarar

Kanonik screenHeightCm. Catalog/factory/collision/BOM ilgili katmanlar bu ölçüyü veya ondan türetilmiş kopyayı okur.
