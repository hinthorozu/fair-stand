...
**Özellik ID:** `bom.lines`
**İnsan tarafından anlaşılır adı:** BOM satırları (itemKey×qty unit)
**Kategori:** bom
**Veri tipi:** string
**Birim:** yok / birimsiz
**İzin verilen değerler / enum / aralık:** TSV'de görülen değerler (canlı dump): `upright_346_5×1 adet` · `upright_99×1 adet` · `upright_49_5×1 adet` · `profile_41_5×1 adet` · `profile_91×1 adet` · `profile_140_5×1 adet` · `profile_190×1 adet` · `panel_48_5×1 adet` · `panel_98×1 adet` · `panel_147_5×1 adet` · `panel_197×1 adet` · `panel_corner_42_5×1 adet` (+66)
