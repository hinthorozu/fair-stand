...
Bu dosya canlı autosave akışını controller'a bağlamadan önce korunması gereken davranışları sabitler.
...
Entegrasyon bu davranışlardan herhangi birini bilinçsizce değiştirmemelidir.
